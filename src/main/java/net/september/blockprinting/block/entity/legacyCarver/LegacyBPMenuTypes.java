...
public class LegacyBPMenuTypes {

    public static final DeferredRegister<MenuType<?>> MENUS =
            DeferredRegister.create(ForgeRegistries.MENU_TYPES, BlockPrinting.MOD_ID);


    public static RegistryObject<MenuType<LegacyStampCarverMenu>> STAMP_CARVER_MENU =
            registerMenuType(LegacyStampCarverMenu::new, "stamp_carver_menu");
